...
Perform data cleaning and exploratory data analysis (EDA) on a real-world dataset. Explore relationships between variables and identify patterns and trends using visualizations.

---

## **📁 Dataset**

The dataset used in this task is the Titanic Dataset from Kaggle. It contains information about passengers on the Titanic and whether they survived.
...
## **📂 Project Structure**
Prodigy_DS_Task2/ │ ├── Titanic-Dataset.csv ├── task2_eda.ipynb └── task2_eda.py
